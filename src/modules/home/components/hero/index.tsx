...
import { HeroImage } from "../../../../../public/icons"
import heroImage from "../../../../../public/images/IMAGE 1.jpg" // Static import

const Hero = () => {
  return (
    <div className="h-full w-full  relative bg-white grid grid-cols-1 lg:grid-cols-5">
      ...
      <div className="flex-1 flex flex-col gap-4 col-span-3 lg:gap-8 items-start justify-center p-6 lg:p-[76px]">
        ...
        <a href="/shop" target="_blank" className="max-lg:w-full">
          <Button
            variant="primary"
